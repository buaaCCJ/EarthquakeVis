...
#include "ArcGISGeometryEngine.generated.h"

class UArcGISGeometry;
class UArcGISPolygon;
class UArcGISPoint;
class UArcGISGeodeticDistanceResult;
class UArcGISPolyline;
class UArcGISProximityResult;
class UArcGISMultipart;
class UArcGISAreaUnit;
class UArcGISLinearUnit;
class UArcGISAngularUnit;
class UArcGISGeodesicEllipseParameters;
class UArcGISSpatialReference;
class UArcGISDatumTransformation;
class UArcGISGeodesicSectorParameters;
...
/// </remarks>
/// <since>1.0.0</since>
class ARCGISMAPSSDK_API UArcGISGeometryEngine :
    public UObject
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "ArcGISMapsSDK|ArcGISGeometryEngine")
    /// <summary>
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static double Area(UArcGISGeometry* geometry);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static double AreaGeodetic(UArcGISGeometry* geometry, UArcGISAreaUnit* unit, EArcGISGeodeticCurveType::Type curveType);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* Boundary(UArcGISGeometry* geometry);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISPolygon* Buffer(UArcGISGeometry* geometry, double distance);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISPolygon* BufferGeodetic(UArcGISGeometry* geometry, double distance, UArcGISLinearUnit* distanceUnit, double maxDeviation, EArcGISGeodeticCurveType::Type curveType);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static bool Contains(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* ConvexHull(UArcGISGeometry* geometry);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISPoint* CreatePointAlong(UArcGISPolyline* polyline, double distance);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static bool Crosses(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* Densify(UArcGISGeometry* geometry, double maxSegmentLength);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* DensifyGeodetic(UArcGISGeometry* geometry, double maxSegmentLength, UArcGISLinearUnit* lengthUnit, EArcGISGeodeticCurveType::Type curveType);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* Difference(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static bool Disjoint(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static double Distance(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeodeticDistanceResult* DistanceGeodetic(UArcGISPoint* point1, UArcGISPoint* point2, UArcGISLinearUnit* distanceUnit, UArcGISAngularUnit* azimuthUnit, EArcGISGeodeticCurveType::Type curveType);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* EllipseGeodesic(UArcGISGeodesicEllipseParameters* parameters);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static bool Equals(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISPolyline* Extend(UArcGISPolyline* polyline, UArcGISPolyline* extender, EArcGISGeometryExtendOptions::Type extendOptions);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static double FractionAlong(UArcGISPolyline* line, UArcGISPoint* point, double tolerance);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* Generalize(UArcGISGeometry* geometry, double maxDeviation, bool removeDegenerateParts);
    ...
    /// <since>1.0.0</since>
    static UArcGISGeometry* Intersection(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static bool Intersects(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static bool IsSimple(UArcGISGeometry* geometry);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISPoint* LabelPoint(UArcGISPolygon* polygon);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static double Length(UArcGISGeometry* geometry);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static double LengthGeodetic(UArcGISGeometry* geometry, UArcGISLinearUnit* lengthUnit, EArcGISGeodeticCurveType::Type curveType);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISProximityResult* NearestCoordinate(UArcGISGeometry* geometry, UArcGISPoint* point);
    ...
    /// Point)
    /// <since>1.0.0</since>
    static UArcGISProximityResult* NearestCoordinateGeodetic(UArcGISGeometry* geometry, UArcGISPoint* point, double maxDeviation, UArcGISLinearUnit* deviationUnit);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISProximityResult* NearestVertex(UArcGISGeometry* geometry, UArcGISPoint* point);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* NormalizeCentralMeridian(UArcGISGeometry* geometry);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* Offset(UArcGISGeometry* geometry, double distance, EArcGISGeometryOffsetType::Type offsetType, double bevelRatio, double flattenError);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static bool Overlaps(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* Project(UArcGISGeometry* geometry, UArcGISSpatialReference* spatialReference);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* ProjectWithTransformation(UArcGISGeometry* geometry, UArcGISSpatialReference* outputSpatialReference, UArcGISDatumTransformation* datumTransformation);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static bool Relate(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2, FString relation);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* RemoveM(UArcGISGeometry* geometry);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* RemoveZ(UArcGISGeometry* geometry);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* RemoveZAndM(UArcGISGeometry* geometry);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISMultipart* Reshape(UArcGISMultipart* geometry, UArcGISPolyline* reshaper);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* SectorGeodesic(UArcGISGeodesicSectorParameters* parameters);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* SetM(UArcGISGeometry* geometry, double m);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* SetZ(UArcGISGeometry* geometry, double z);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* SetZAndM(UArcGISGeometry* geometry, double z, double m);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* Simplify(UArcGISGeometry* geometry);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* SymmetricDifference(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static bool Touches(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISGeometry* Union(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static bool Within(UArcGISGeometry* geometry1, UArcGISGeometry* geometry2);
