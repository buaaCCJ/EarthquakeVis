...
#include "ArcGISAttributeType.generated.h"

UENUM(BlueprintType, meta=(ScriptName="ArcGISAttributeType"))
namespace EArcGISAttributeType
{
    enum Type
    {
        Null = 0 UMETA(Hidden),
        ...
        /// (The attribute can be accessed at full precision by attaching an <see cref="Esri::GameEngine::Attributes::ArcGISAttributeProcessor">ArcGISAttributeProcessor</see> to the layer).
        /// </remarks>
        /// <since>1.0.0</since>
        Int32 = 6,
