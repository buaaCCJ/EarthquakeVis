...
#include "ArcGISMGRSConversionMode.generated.h"

UENUM(BlueprintType, meta=(ScriptName="ArcGISMGRSConversionMode"))
namespace EArcGISMGRSConversionMode
{
    enum Type
    {
        /// <summary>
        ...
        /// <see cref="Esri::GameEngine::Geometry::ArcGISMGRSConversionMode.new180InZone60">ArcGISMGRSConversionMode.new180InZone60</see>. Spatial references with older
        /// datums (e.g. Clarke 1866, Bessel 1841, Clarke 1880) assume old
        /// lettering scheme (AL scheme). This is equivalent to
        /// <see cref="Esri::GameEngine::Geometry::ArcGISMGRSConversionMode.old180InZone60">ArcGISMGRSConversionMode.old180InZone60</see>.  When converted, points with
