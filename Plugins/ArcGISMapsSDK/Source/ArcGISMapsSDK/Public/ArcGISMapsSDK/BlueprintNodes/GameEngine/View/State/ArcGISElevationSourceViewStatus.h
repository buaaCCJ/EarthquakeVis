...
#include "ArcGISElevationSourceViewStatus.generated.h"

UENUM(BlueprintType, meta=(ScriptName="ArcGISElevationSourceViewStatus"))
namespace EArcGISElevationSourceViewStatus
{
    enum Type
    {
        Null = 0 UMETA(Hidden),
