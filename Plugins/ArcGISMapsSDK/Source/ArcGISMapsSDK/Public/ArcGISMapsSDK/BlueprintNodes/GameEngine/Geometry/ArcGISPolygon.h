...
#include "ArcGISPolygon.generated.h"
...
/// <since>1.0.0</since>
class ARCGISMAPSSDK_API UArcGISPolygon :
    public UArcGISMultipart
{
    GENERATED_BODY()

public:
    #pragma region Methods
    UFUNCTION(BlueprintCallable, Category = "ArcGISMapsSDK|ArcGISPolygon")
    /// <summary>
