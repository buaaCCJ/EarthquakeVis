...
#include "ArcGISElevationSourceCollection.generated.h"
...
/// </remarks>
/// <since>1.0.0</since>
class ARCGISMAPSSDK_API UArcGISElevationSourceCollection :
    public UObject
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "ArcGISMapsSDK|ArcGISElevationSourceCollection")
    /// <summary>
    /// Creates a vector. This allocates memory that must be deleted.
    /// </summary>
    /// <since>1.0.0</since>
    static UArcGISElevationSourceCollection* CreateArcGISElevationSourceCollection();
    ...
    /// </returns>
    /// <since>1.0.0</since>
    int64 Add(UArcGISElevationSource* value);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    int64 AddArray(UArcGISElevationSourceCollection* vector2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    UArcGISElevationSource* At(int64 position) const;
    ...
    /// </returns>
    /// <since>1.0.0</since>
    bool Contains(UArcGISElevationSource* value) const;
    ...
    /// </returns>
    /// <since>1.0.0</since>
    bool Equals(UArcGISElevationSourceCollection* vector2) const;
    ...
    /// </returns>
    /// <since>1.0.0</since>
    UArcGISElevationSource* First() const;
    ...
    /// </returns>
    /// <since>1.0.0</since>
    int64 IndexOf(UArcGISElevationSource* value) const;
    ...
    /// <param name="value">The value that is to be added.</param>
    /// <since>1.0.0</since>
    void Insert(int64 position, UArcGISElevationSource* value);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    UArcGISElevationSource* Last() const;
...
public:
    TSharedPtr<Esri::Unreal::ArcGISCollection<Esri::GameEngine::Elevation::Base::ArcGISElevationSource>> APIObject;
};