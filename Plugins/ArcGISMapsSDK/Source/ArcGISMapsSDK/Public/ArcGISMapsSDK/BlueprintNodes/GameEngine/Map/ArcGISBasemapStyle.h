...
#include "ArcGISBasemapStyle.generated.h"

UENUM(BlueprintType, meta=(ScriptName="ArcGISBasemapStyle"))
namespace EArcGISBasemapStyle
{
    enum Type
    {
        /// <summary>
        ...
        /// <summary>
        /// A vector basemap with labels for the world as the reference layer. Designed to be overlaid on <see cref="Esri::GameEngine::Map::ArcGISBasemapStyle.arcGISImageryStandard">ArcGISBasemapStyle.arcGISImageryStandard</see>.
        /// </summary>
        /// <since>1.0.0</since>
        ...
        /// <summary>
        /// A vector basemap with labels for the world as the reference layer. Designed to be overlaid on  light neutral backgrounds such as the <see cref="Esri::GameEngine::Map::ArcGISBasemapStyle.arcGISLightGrayBase">ArcGISBasemapStyle.arcGISLightGrayBase</see> style.
        /// </summary>
        /// <since>1.0.0</since>
        ...
        /// <summary>
        /// A vector basemap with labels for the world as the reference layer. Designed to be overlaid on dark neutral backgrounds such as the <see cref="Esri::GameEngine::Map::ArcGISBasemapStyle.arcGISDarkGrayBase">ArcGISBasemapStyle.arcGISDarkGrayBase</see> style.
        /// </summary>
        /// <since>1.0.0</since>
        ...
        /// <summary>
        /// A vector basemap for the world featuring a 'dark mode' version of the <see cref="Esri::GameEngine::Map::ArcGISBasemapStyle.arcGISNavigation">ArcGISBasemapStyle.arcGISNavigation</see> style, using the same content.
        /// </summary>
        /// <since>1.0.0</since>
        ...
        /// <summary>
        /// A vector basemap with labels for the world as the reference layer. Designed to be overlaid on <see cref="Esri::GameEngine::Map::ArcGISBasemapStyle.arcGISOceansBase">ArcGISBasemapStyle.arcGISOceansBase</see>.
        /// </summary>
        /// <since>1.0.0</since>
        ...
        /// reference layer. Designed to be overlaid on <see cref="Esri::GameEngine::Map::ArcGISBasemapStyle.arcGISTerrainBase">ArcGISBasemapStyle.arcGISTerrainBase</see> and hillshade.
        /// </summary>
        /// <since>1.0.0</since>
        ...
        /// with minimal colors such as <see cref="Esri::GameEngine::Map::ArcGISBasemapStyle.OSMLightGrayBase">ArcGISBasemapStyle.OSMLightGrayBase</see>.
        /// </summary>
        /// <since>1.0.0</since>
        ...
        /// <summary>
        /// A vector basemap version of Open Street Map (OSM) data hosted by Esri. Contains only labels as the reference layer. Designed to be overlaid on dark neutral styles with minimal colors such as <see cref="Esri::GameEngine::Map::ArcGISBasemapStyle.OSMDarkGrayBase">ArcGISBasemapStyle.OSMDarkGrayBase</see>.
        /// </summary>
        /// <since>1.0.0</since>
