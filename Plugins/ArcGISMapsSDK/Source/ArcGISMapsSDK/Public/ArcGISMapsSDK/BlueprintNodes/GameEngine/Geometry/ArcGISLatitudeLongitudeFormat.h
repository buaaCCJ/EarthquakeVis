...
#include "ArcGISLatitudeLongitudeFormat.generated.h"

UENUM(BlueprintType, meta=(ScriptName="ArcGISLatitudeLongitudeFormat"))
namespace EArcGISLatitudeLongitudeFormat
{
    enum Type
    {
        /// <summary>
