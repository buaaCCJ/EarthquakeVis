...
#include "ArcGISCoordinateFormatter.generated.h"
...
namespace Geometry
{
class ArcGISCoordinateFormatter;
} // namespace Geometry
} // namespace GameEngine
} // namespace Esri
...
/// </summary>
/// <since>1.0.0</since>
class ARCGISMAPSSDK_API UArcGISCoordinateFormatter :
    public UObject
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "ArcGISMapsSDK|ArcGISCoordinateFormatter")
    /// <summary>
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISPoint* FromGARS(FString coordinates, UArcGISSpatialReference* spatialReference, EArcGISGARSConversionMode::Type GARSConversionMode);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISPoint* FromGeoRef(FString coordinates, UArcGISSpatialReference* spatialReference);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISPoint* FromLatitudeLongitude(FString coordinates, UArcGISSpatialReference* spatialReference);
    ...
    /// notation string, please see <see cref="Esri::GameEngine::Geometry::ArcGISMGRSConversionMode">ArcGISMGRSConversionMode</see>. Note that the
    ...
    /// spatial reference provided.
    /// </returns>
    /// <seealso cref="Esri::GameEngine::Geometry::ArcGISMGRSConversionMode">ArcGISMGRSConversionMode</seealso>
    /// <since>1.0.0</since>
    static UArcGISPoint* FromMGRS(FString coordinates, UArcGISSpatialReference* spatialReference, EArcGISMGRSConversionMode::Type MGRSConversionMode);
    ...
    /// <seealso cref="Esri::GameEngine::Geometry::ArcGISMGRSConversionMode">ArcGISMGRSConversionMode</seealso>
    /// <since>1.0.0</since>
    static UArcGISPoint* FromUSNG(FString coordinates, UArcGISSpatialReference* spatialReference);
    ...
    /// <seealso cref="Esri::GameEngine::Geometry::ArcGISMGRSConversionMode">ArcGISMGRSConversionMode</seealso>
    /// <since>1.0.0</since>
    static UArcGISPoint* FromUTM(FString coordinates, UArcGISSpatialReference* spatialReference, EArcGISUTMConversionMode::Type UTMConversionMode);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static FString ToGARS(UArcGISPoint* point);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static FString ToGeoRef(UArcGISPoint* point, int32 precision);
    ...
    /// -------------- | ------------------------------------------------- | ---------------------------- | ----------------- | -----------------
    /// 0              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.decimalDegrees">ArcGISLatitudeLongitudeFormat.decimalDegrees</see>        | 056N 0003W                   | 1deg              | 100km
    /// 1              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.decimalDegrees">ArcGISLatitudeLongitudeFormat.decimalDegrees</see>        | 55.9N 003.2W                 | 0.1deg            | 10km
    /// 2              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.decimalDegrees">ArcGISLatitudeLongitudeFormat.decimalDegrees</see>        | 55.94N 003.16W               | 0.01deg           | 1km
    /// 3              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.decimalDegrees">ArcGISLatitudeLongitudeFormat.decimalDegrees</see>        | 55.944N 003.162W             | 0.001deg          | 100m
    /// 0              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.degreesDecimalMinutes">ArcGISLatitudeLongitudeFormat.degreesDecimalMinutes</see> | 55 057N 003 010W             | 1min              | 2km
    /// 1              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.degreesDecimalMinutes">ArcGISLatitudeLongitudeFormat.degreesDecimalMinutes</see> | 55 56.7N 003 09.7W           | 0.1min            | 200m
    /// 2              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.degreesDecimalMinutes">ArcGISLatitudeLongitudeFormat.degreesDecimalMinutes</see> | 55 56.65N 003 09.72W         | 0.01min           | 20m
    /// 3              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.degreesDecimalMinutes">ArcGISLatitudeLongitudeFormat.degreesDecimalMinutes</see> | 55 56.650N 003 09.717W       | 0.001min          | 2m
    /// 0              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.degreesMinutesSeconds">ArcGISLatitudeLongitudeFormat.degreesMinutesSeconds</see> | 55 56 039N 003 09 043W       | 1sec              | 30m
    /// 1              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.degreesMinutesSeconds">ArcGISLatitudeLongitudeFormat.degreesMinutesSeconds</see> | 55 56 39.1N 003 09 43.0W     | 0.1sec            | 3m
    /// 2              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.degreesMinutesSeconds">ArcGISLatitudeLongitudeFormat.degreesMinutesSeconds</see> | 55 56 39.12N 003 09 43.03W   | 0.01sec           | 300mm
    /// 3              | <see cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat.degreesMinutesSeconds">ArcGISLatitudeLongitudeFormat.degreesMinutesSeconds</see> | 55 56 39.123N 003 09 43.034W | 0.001sec          | 30mm
    /// At the equator to 1 significant figure.
    ...
    /// given point.
    /// </returns>
    /// <seealso cref="Esri::GameEngine::Geometry::ArcGISLatitudeLongitudeFormat">ArcGISLatitudeLongitudeFormat</seealso>
    /// <since>1.0.0</since>
    static FString ToLatitudeLongitude(UArcGISPoint* point, EArcGISLatitudeLongitudeFormat::Type format, int32 decimalPlaces);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static FString ToMGRS(UArcGISPoint* point, EArcGISMGRSConversionMode::Type MGRSConversionMode, int32 precision, bool addSpaces);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static FString ToUSNG(UArcGISPoint* point, int32 precision, bool addSpaces);
    ...
    /// -------------------------------------------- | ------------------- | -------------------
    /// <see cref="Esri::GameEngine::Geometry::ArcGISUTMConversionMode.latitudeBandIndicators">ArcGISUTMConversionMode.latitudeBandIndicators</see> | false               | 30U4898846199881
    /// <see cref="Esri::GameEngine::Geometry::ArcGISUTMConversionMode.latitudeBandIndicators">ArcGISUTMConversionMode.latitudeBandIndicators</see> | true                | 30U 489884 6199881
    /// <see cref="Esri::GameEngine::Geometry::ArcGISUTMConversionMode.northSouthIndicators">ArcGISUTMConversionMode.northSouthIndicators</see>   | false               | 30N4898846199881
    /// <see cref="Esri::GameEngine::Geometry::ArcGISUTMConversionMode.northSouthIndicators">ArcGISUTMConversionMode.northSouthIndicators</see>   | true                | 30N 489884 6199881
    /// The point must have a spatial reference.
    /// Returns null on error.
    /// </remarks>
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static FString ToUTM(UArcGISPoint* point, EArcGISUTMConversionMode::Type UTMConversionMode, bool addSpaces);
