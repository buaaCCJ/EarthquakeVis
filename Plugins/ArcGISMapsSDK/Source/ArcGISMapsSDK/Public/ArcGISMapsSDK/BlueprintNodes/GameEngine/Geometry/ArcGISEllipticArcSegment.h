...
#include "ArcGISEllipticArcSegment.generated.h"
...
namespace Geometry
{
class ArcGISEllipticArcSegment;
} // namespace Geometry
} // namespace GameEngine
} // namespace Esri
...
/// </remarks>
/// <since>1.0.0</since>
class ARCGISMAPSSDK_API UArcGISEllipticArcSegment :
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "ArcGISMapsSDK|ArcGISEllipticArcSegment")
    /// <summary>
    ...
    /// <since>1.0.0</since>
    static UArcGISEllipticArcSegment* CreateArcGISEllipticArcSegmentWithCenter(UArcGISPoint* centerPoint, double rotationAngle, double semiMajorAxis, double minorMajorRatio, double startAngle, double centralAngle, UArcGISSpatialReference* spatialReference);
    ...
    /// <since>1.0.0</since>
    static UArcGISEllipticArcSegment* CreateArcGISEllipticArcSegmentWithStartAndEndpoints(UArcGISPoint* startPoint, UArcGISPoint* endPoint, double rotationAngle, bool isMinor, bool isCounterClockwise, double semiMajorAxis, double minorMajorRatio, UArcGISSpatialReference* spatialReference);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISEllipticArcSegment* CreateCircularEllipticArcWithCenterRadiusAndAngles(UArcGISPoint* centerPoint, double radius, double startAngle, double centralAngle, UArcGISSpatialReference* spatialReference);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    static UArcGISEllipticArcSegment* CreateCircularEllipticArcWithStartEndAndInterior(UArcGISPoint* startPoint, UArcGISPoint* endPoint, UArcGISPoint* interiorPoint, UArcGISSpatialReference* spatialReference);
