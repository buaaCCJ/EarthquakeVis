...
#include "ArcGISVisualizationAttributeType.generated.h"

UENUM(BlueprintType, meta=(ScriptName="ArcGISVisualizationAttributeType"))
namespace EArcGISVisualizationAttributeType
{
    enum Type
    {
        /// <summary>
