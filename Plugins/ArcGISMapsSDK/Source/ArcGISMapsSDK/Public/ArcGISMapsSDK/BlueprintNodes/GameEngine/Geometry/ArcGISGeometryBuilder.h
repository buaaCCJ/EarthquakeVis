...
#include "ArcGISGeometryBuilder.generated.h"
...
/// </summary>
/// <since>1.0.0</since>
class ARCGISMAPSSDK_API UArcGISGeometryBuilder :
    public UObject
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "ArcGISMapsSDK|ArcGISGeometryBuilder")
    /// <summary>
    ...
    /// <since>1.0.0</since>
    static UArcGISGeometryBuilder* CreateFromGeometry(UArcGISGeometry* geometry);
    ...
    /// <seealso cref="Esri::GameEngine::Geometry::ArcGISGeometryBuilder.hasCurves">ArcGISGeometryBuilder.hasCurves</seealso>
    /// <since>1.0.0</since>
    static UArcGISGeometryBuilder* CreateFromGeometryTypeAndSpatialReference(EArcGISGeometryType::Type geometryType, UArcGISSpatialReference* spatialReference);
    ...
    /// <since>1.0.0</since>
    void ReplaceGeometry(UArcGISGeometry* geometry);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    UArcGISGeometry* ToGeometry() const;
    #pragma endregion Methods

public:
    TSharedPtr<Esri::GameEngine::Geometry::ArcGISGeometryBuilder> APIObject;
};