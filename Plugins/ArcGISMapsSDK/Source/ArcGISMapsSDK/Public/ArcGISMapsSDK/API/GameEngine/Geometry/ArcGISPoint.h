...
/// <since>1.0.0</since>
class ARCGISMAPSSDK_API ArcGISPoint :
...
public:
    ...
    /// <seealso cref="Esri::GameEngine::Geometry::ArcGISSpatialReference">ArcGISSpatialReference</seealso>
    /// <since>1.0.0</since>
    ArcGISPoint(double x, double y, double z);
    ...
    /// <seealso cref="Esri::GameEngine::Geometry::ArcGISSpatialReference">ArcGISSpatialReference</seealso>
    /// <since>1.0.0</since>
    ArcGISPoint(double x, double y, double z, const ArcGISSpatialReference& spatialReference);
    ...
    /// <seealso cref="Esri::GameEngine::Geometry::ArcGISSpatialReference">ArcGISSpatialReference</seealso>
    /// <since>1.0.0</since>
    ArcGISPoint(double x, double y, const ArcGISSpatialReference& spatialReference);
...
public:
    ...
    explicit ArcGISPoint(void* handle);
    ArcGISPoint(const ArcGISPoint&) = delete;
    ArcGISPoint(ArcGISPoint&& other) noexcept;
    ArcGISPoint();
    virtual ~ArcGISPoint() = default;
    
    ArcGISPoint& operator=(const ArcGISPoint&) = delete;
    ArcGISPoint& operator=(ArcGISPoint&& other) = default;
