...
namespace Geometry
{
enum class ArcGISGARSConversionMode;
enum class ArcGISLatitudeLongitudeFormat;
enum class ArcGISMGRSConversionMode;
class ArcGISPoint;
class ArcGISSpatialReference;
enum class ArcGISUTMConversionMode;
...
/// </summary>
/// <since>1.0.0</since>
class ARCGISMAPSSDK_API ArcGISCoordinateFormatter
{
public:
