...
/// </remarks>
/// <since>1.0.0</since>
class ARCGISMAPSSDK_API ArcGISDatumTransformation
{
...
public:
    ...
    explicit ArcGISDatumTransformation(void* handle);
    ArcGISDatumTransformation(const ArcGISDatumTransformation&) = delete;
    ArcGISDatumTransformation(ArcGISDatumTransformation&& other) noexcept;
    ArcGISDatumTransformation() = default;
    ~ArcGISDatumTransformation();
    
    ArcGISDatumTransformation& operator=(const ArcGISDatumTransformation&) = delete;
    ArcGISDatumTransformation& operator=(ArcGISDatumTransformation&& other) noexcept;
