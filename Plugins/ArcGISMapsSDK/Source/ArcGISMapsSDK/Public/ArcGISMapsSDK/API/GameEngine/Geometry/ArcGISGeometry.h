...
/// <since>1.0.0</since>
class ARCGISMAPSSDK_API ArcGISGeometry
{
...
public:
    ...
    /// </summary>
    /// <remarks>
    /// Returns <see cref="Esri::GameEngine::Geometry::ArcGISGeometryDimension.unknown">ArcGISGeometryDimension.unknown</see> if an error occurs.
    /// </remarks>
    /// <seealso cref="Esri::GameEngine::Geometry::ArcGISGeometryDimension">ArcGISGeometryDimension</seealso>
    /// <since>1.0.0</since>
...
public:
    ...
    explicit ArcGISGeometry(void* handle);
    ArcGISGeometry(const ArcGISGeometry&) = delete;
    ArcGISGeometry(ArcGISGeometry&& other) noexcept;
    ArcGISGeometry() = default;
    ~ArcGISGeometry();
    
    ArcGISGeometry& operator=(const ArcGISGeometry&) = delete;
    ArcGISGeometry& operator=(ArcGISGeometry&& other) noexcept;
