...
/// <since>1.0.0</since>
class ARCGISMAPSSDK_API ArcGISMultipart :
...
public:
    ...
    explicit ArcGISMultipart(void* handle);
    ArcGISMultipart(const ArcGISMultipart&) = delete;
    ArcGISMultipart(ArcGISMultipart&& other) noexcept;
    ArcGISMultipart();
    virtual ~ArcGISMultipart() = default;
    
    ArcGISMultipart& operator=(const ArcGISMultipart&) = delete;
    ArcGISMultipart& operator=(ArcGISMultipart&& other) = default;
