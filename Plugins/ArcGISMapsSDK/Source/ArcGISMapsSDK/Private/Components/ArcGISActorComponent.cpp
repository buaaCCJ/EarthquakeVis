...
bool UArcGISActorComponent::IsInEditorPreviewActor() const
{
	auto Owner = GetOwner();
...
void UArcGISActorComponent::OnRegister()
{
	Super::OnRegister();
...
void UArcGISActorComponent::OnUnregister()
{
#if WITH_EDITORONLY_DATA
	if (!IsInEditorPreviewActor())
#endif
...
void UArcGISActorComponent::OnArcGISMapComponentChanged(UArcGISMapComponent* InMapComponent)
{
