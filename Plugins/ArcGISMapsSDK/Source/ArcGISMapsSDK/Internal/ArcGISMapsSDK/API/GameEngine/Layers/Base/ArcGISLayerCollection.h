...
public:
    ...
    /// </returns>
    /// <since>1.0.0</since>
    size_t Add(const ArcGISLayer& value);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    size_t AddArray(const Unreal::ArcGISCollection<ArcGISLayer>& vector2);
    ...
    /// </returns>
    /// <since>1.0.0</since>
    ArcGISLayer At(size_t position) const;
    ...
    /// </returns>
    /// <since>1.0.0</since>
    bool Contains(const ArcGISLayer& value) const;
    ...
    /// </returns>
    /// <since>1.0.0</since>
    bool Equals(const Unreal::ArcGISCollection<ArcGISLayer>& vector2) const;
    ...
    /// </returns>
    /// <since>1.0.0</since>
    size_t IndexOf(ArcGISLayer& value) const;
    ...
    /// <param name="value">The value that is to be added.</param>
    /// <since>1.0.0</since>
    void Insert(size_t position, const ArcGISLayer& value);
...
public:
    ...
    explicit ArcGISLayerCollection(void* handle);
    ArcGISLayerCollection(const ArcGISLayerCollection&) = delete;
    ArcGISLayerCollection(ArcGISLayerCollection&& other) noexcept;
    ~ArcGISLayerCollection();
    
    ArcGISLayerCollection& operator=(const ArcGISLayerCollection&) = delete;
    ArcGISLayerCollection& operator=(ArcGISLayerCollection&& other) noexcept;
